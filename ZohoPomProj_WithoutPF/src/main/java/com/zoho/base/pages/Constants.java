...
public class Constants {
	...
	//Keys
	public static final String HOME_LINK_KEY = "login_link_css";
	public static final String URK_KEY = "url";
	public static final String USERNAME_FIELD_KEY = "username_textfield_id";
	public static final String NEXT_BUTTON_KEY="username_submit_next_button_xpath";
	public static final String HOME_PAGE_TITLE_KEY = "home_page_title";
	public static final String HOME_PAGE_TEXT_KEY = "homepage_text_xpath";
	public static final String PASSWORD_FIELD_KEY = "password_textfield_id";
